...
const props = defineProps({
  ...
  priorityOptions: { type: Array as PropType<FilterOption[]>, default: () => [
    ...
    { id: 'moyen', label: 'MOYEN', icon: 'ph:equals-bold', colorClass: 'text-blue-700 dark:text-primary' },
    ...
    <div @click="toggleDropdown">
      <slot name="trigger">
        <button 
          ...
          :class="{ 'ring-2 ring-primary dark:ring-primary': isOpen }"
        >
        ...
        <div v-if="showDateSort" class="p-3">
          ...
          <div class="flex flex-col gap-2">
            <label class="flex items-center gap-2 cursor-pointer group" @click.prevent="setDateSort('recent')">
              <div class="relative flex items-center justify-center w-4 h-4 rounded-full border bg-canvas dark:bg-[#2A2A2D] group-hover:border-primary transition-colors" :class="selectedDateSort === 'recent' ? 'border-primary dark:border-primary btn-primary dark:btn-primary text-white' : 'border-form-border dark:border-gray-600'">
            ...
            <label class="flex items-center gap-2 cursor-pointer group" @click.prevent="setDateSort('oldest')">
              <div class="relative flex items-center justify-center w-4 h-4 rounded-full border bg-canvas dark:bg-[#2A2A2D] group-hover:border-primary transition-colors" :class="selectedDateSort === 'oldest' ? 'border-primary dark:border-primary btn-primary dark:btn-primary text-white' : 'border-form-border dark:border-gray-600'">
        ...
        <div v-if="showPriority" class="p-3">
          ...
          <div class="flex flex-col gap-2">
            <label v-for="priority in priorityOptions" :key="priority.id" class="flex items-center gap-2 cursor-pointer group" @click.prevent="togglePriority(priority.id)">
              <div class="relative flex items-center justify-center w-4 h-4 border rounded bg-canvas dark:bg-[#2A2A2D] group-hover:border-primary transition-colors shrink-0" :class="selectedPriorities.includes(priority.id) ? 'border-primary dark:border-primary btn-primary dark:btn-primary text-white' : 'border-form-border dark:border-gray-600 text-transparent'">
        ...
        <div v-if="showStatus" class="p-3">
          ...
          <div class="flex flex-col gap-2">
            <label v-for="status in statusOptions" :key="status.id" class="flex items-center gap-2 cursor-pointer group" @click.prevent="toggleStatus(status.id)">
              <div class="relative flex items-center justify-center w-4 h-4 border rounded bg-canvas dark:bg-[#2A2A2D] group-hover:border-primary transition-colors" :class="selectedStatuses.includes(status.id) ? 'border-primary dark:border-primary btn-primary dark:btn-primary text-white' : 'border-form-border dark:border-gray-600 text-transparent'">
                 <Icon name="heroicons:check" class="w-3 h-3" />
              </div>
        ...
        <div v-if="showTags" class="p-3">
          ...
          <div class="flex flex-col gap-2">
            <label v-for="tag in tagOptions" :key="tag.id" class="flex items-center gap-2 cursor-pointer group" @click.prevent="toggleTag(tag.id)">
              <div class="relative flex items-center justify-center w-4 h-4 border rounded bg-canvas dark:bg-[#2A2A2D] group-hover:border-primary transition-colors" :class="selectedTags.includes(tag.id) ? 'border-primary dark:border-primary btn-primary dark:btn-primary text-white' : 'border-form-border dark:border-gray-600 text-transparent'">
                 <Icon name="heroicons:check" class="w-3 h-3" />
              </div>
        ...
        <div v-if="showProjects" class="p-3">
          ...
          <div class="flex flex-col gap-2">
            <label v-for="project in projectOptions" :key="project.id" class="flex items-center gap-2 cursor-pointer group" @click.prevent="toggleProject(project.id)">
              <div class="relative flex items-center justify-center w-4 h-4 border rounded bg-canvas dark:bg-[#2A2A2D] group-hover:border-primary transition-colors" :class="selectedProjects.includes(project.id) ? 'border-primary dark:border-primary btn-primary dark:btn-primary text-white' : 'border-form-border dark:border-gray-600 text-transparent'">
                 <Icon name="heroicons:check" class="w-3 h-3" />
              </div>
