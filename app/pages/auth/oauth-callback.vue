...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#151515]">
    <div class="text-center">
      ...
      <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Authentification en cours...</h2>
