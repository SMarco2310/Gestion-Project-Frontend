        ...
        <div class="w-full space-y-8">
          ...
          <div v-else-if="!isAuthenticated && token">
            ...
            <div class="flex flex-col space-y-4">
              <NuxtLink :to="`/auth/login?redirect=/invite?token=${token}`" class="w-full py-4 px-4 bg-cyan-600 text-white font-bold text-lg rounded-full neo-emboss border border-cyan-600/50 hover:brightness-110 active:neo-inset active:scale-[0.98] transition-all flex items-center justify-center">
                Se connecter
              </NuxtLink>
          ...
          <div v-else-if="invitation" class="animate-in fade-in zoom-in duration-300">
            ...
            <div v-else>
              ...
              <button
                @click="handleAccept"
                :disabled="isLoading"
                class="w-full py-4 px-4 bg-cyan-600 text-white font-bold text-lg rounded-full neo-emboss border border-cyan-600/50 hover:brightness-110 active:neo-inset active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
              >
